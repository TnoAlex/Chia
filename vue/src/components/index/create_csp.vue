                    ...
                    <div class="row">
                        ...
                        <div class="mb-0">
                          ...
                          <div class="mt-2" id="tooltip-container">
                            <a href="javascript:void(0);" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme" class="d-inline-block">
                              <img src="assets/picture/avatar-6.jpg" class="rounded-circle avatar-xs" alt="friend">
                            </a>
                            ...
                            <a href="javascript:void(0);" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Michael Zenaty" class="d-inline-block">
                              <img src="assets/picture/avatar-7.jpg" class="rounded-circle avatar-xs" alt="friend">
                            </a>
                            ...
                            <a href="javascript:void(0);" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="James Anderson" class="d-inline-block">
                              <img src="assets/picture/avatar-8.jpg" class="rounded-circle avatar-xs" alt="friend">
                            </a>
                            ...
                            <a href="javascript:void(0);" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Lorene Block" class="d-inline-block">
                              <img src="assets/picture/avatar-4.jpg" class="rounded-circle avatar-xs" alt="friend">
                            </a>
                            ...
                            <a href="javascript:void(0);" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Mike Baker" class="d-inline-block">
                              <img src="assets/picture/avatar-5.jpg" class="rounded-circle avatar-xs" alt="friend">
                            </a>
                          </div>
                      ...
                      <div class="col-xl-6">
                        <div class="mb-3 mt-3 mt-xl-0">
                          ...
                          <form action="javascript:;" method="post" class="dropzone" id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate">
                            <div class="fallback">
                            ...
                            <div class="card mt-1 mb-0 shadow-none border">
                              <div class="p-2">
                                <div class="row align-items-center">
                                  <div class="col-auto">
                                    <img data-dz-thumbnail="" src="assets/picture/apps-projects-add2.html" class="avatar-sm rounded bg-light" alt="">
                                  </div>
                                  <div class="col ps-0">
