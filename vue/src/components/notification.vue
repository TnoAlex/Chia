                        ...
                        <div class="dropdown position-absolute end-0 top-0 mt-3 me-3">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="cardNotiAction6">
                            <li @click="deleteNotification(index)">
                              <a class="dropdown-item" href="###">
                                <i class="bi bi-trash fa-fw pe-2">删除</i>
                                </a>
                            </li>
...
import leftNav from "@/components/index/leftNav.vue";
...
<style scoped src="../assets/css/notification/font.css"></style>
<style scoped src="../assets/css/notification/all.min.css"></style>
<style scoped src="../assets/css/notification/style.css"></style>
<style scoped src="../assets/css/notification/css2.css"></style>
<style scoped src="../assets/css/notification/iconfont.css"></style>
<style>
.loading {
  display: flex;
  align-items: center;
